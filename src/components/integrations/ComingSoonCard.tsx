...
export function ComingSoonCard({ name, emoji }: ComingSoonCardProps) {
    return (
        <Card className="group h-full flex flex-col p-6 bg-white border border-slate-200/50 border-dashed rounded-3xl opacity-60 hover:opacity-100 transition-opacity min-h-[140px] sm:min-h-[180px] relative">

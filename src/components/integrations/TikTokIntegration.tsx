...
export function TikTokIntegration({ userId }: TikTokIntegrationProps) {
    const {
        pixels: profiles,
        addPixel,
        updatePixel,
                ...
                <SheetContent hideClose className="sm:max-w-md w-full flex flex-col h-full p-0 gap-0 bg-white overflow-hidden sm:border-l sm:shadow-2xl">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col">
                                    {view === 'add' ? (
                                        ...
                                        <>
                                            <SheetTitle className="text-slate-900 leading-tight">TikTok Pixels</SheetTitle>
                            ...
                            <div className="flex items-center gap-2">
                                {activeTab === 'manage' && (
                                    view === 'list' ? (
                                        <Button
                                            size="sm"
                                            className="bg-slate-900 hover:bg-slate-800 text-white h-8 text-xs gap-1.5 shadow-sm px-3 rounded-full"
                                            onClick={() => {
                                                startAddProfile();
                                                setActiveTab('manage');
                                            }}
                    ...
                    <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'manage' | 'guide')} className="flex-1 flex flex-col min-h-0">
                        <TabsList className="grid w-full grid-cols-2 bg-slate-50 p-1 rounded-none shrink-0 border-b border-slate-100">
                            <TabsTrigger value="manage" className="rounded-md data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:text-slate-900 text-xs font-medium text-slate-500">Manage</TabsTrigger>
                            <TabsTrigger value="guide" className="rounded-md data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:text-slate-900 text-xs font-medium text-slate-500">Setup Guide</TabsTrigger>
                        </TabsList>
                        ...
                        <ScrollArea className="flex-1 bg-slate-50/50 [&>div>div]:!block">
                            ...
                            <TabsContent value="guide" className="mt-0 p-6">
                                <div className="space-y-4 text-sm text-slate-600">
                                    ...
                                    <div className="bg-slate-50 border border-slate-200 rounded-lg p-3 text-xs text-slate-700 flex gap-2 items-start">
